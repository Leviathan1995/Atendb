			...
			while (AttributesNum < SelectAttributesnumber)
			{
				...
				if (WhereAttributesNumber != -1)
				{
					...
					for (int i = 0; i < Tuple_Num; i++)
					{
						...
						{
						case LESS_THAN:
							if (Intepretor::String2Int(Tuple_Record[i].Tuple_content[WhereAttributesNumber])<Intepretor::String2Int(WhereValues))
								selectrecord.selectrecords.push_back(Tuple_Record[i].Tuple_content[SelectAttributesNumber]);
							break;
						case EQUAL:
							if (Intepretor::String2Int(Tuple_Record[i].Tuple_content[WhereAttributesNumber])<Intepretor::String2Int(WhereValues))
								selectrecord.selectrecords.push_back(Tuple_Record[i].Tuple_content[SelectAttributesNumber]);
